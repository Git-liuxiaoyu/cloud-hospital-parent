...
public class RabbitMQConfig {
    ...
    public RabbitMQConfig(MessagePoDao messagePoDao) {
    ...
    public RabbitTemplate createRabbitTemplate(ConnectionFactory connectionFactory) {
        ...
        rabbitTemplate.setConfirmCallback((correlationData, ack, cause) -> {
            ...
            if (ack) {
                ...
                messagePo.setStatus(MessagePo.SEND_TO_EX_SUCCESS); /* 切换状态 */
            } else {
                /* 没有重试次数 */
                if (messagePo.getRetryCount() <= 0) {
                    ...
                    /* 填值 */
                    messagePo.setVersion(messagePo.getVersion() + 1);
                    messagePo.setStatus(MessagePo.SEND_TO_EX_FAIL); /* 切换状态 */
                    /* 调用方法更新 */
        ...
        rabbitTemplate.setReturnCallback(new RabbitTemplate.ReturnCallback() {
            ...
            public void returnedMessage(Message message, int replyCode, String replyText, String exchange, String routingKey) {
                ...
                if (messagePo.getRetryCount() <= 0) {
                    ...
                    /* 填值 */
                    messagePo.setVersion(messagePo.getVersion() + 1);
                    messagePo.setStatus(MessagePo.SEND_TO_Q_FAIL); /* 切换状态 */
                    /* 调用方法更新 */
                    messagePoDao.updateByExampleSelective(messagePo, messagePoExample);
                } else {
