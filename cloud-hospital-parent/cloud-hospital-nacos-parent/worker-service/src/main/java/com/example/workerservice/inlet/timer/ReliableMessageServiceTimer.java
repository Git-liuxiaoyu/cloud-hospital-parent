package com.example.workerservice.inlet.timer;
...
public class ReliableMessageServiceTimer {
    ...
    public ReliableMessageServiceTimer(RabbitTemplate rabbitTemplate, MessagePoDao messagePoDao) {
    ...
    private void autoSend() {
        ...
        /* 创造条件 */
        messagePoExample.createCriteria().andStatusEqualTo(MessagePo.NOT_SEND);

        List<MessagePo> messageList = messagePoDao.selectByExample(messagePoExample);
